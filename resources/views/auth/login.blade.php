                                ...
                                <form method="POST" action="{{ route('login') }}">
                                    ...
                                    <div class="relative w-full mb-3">
                                        ...
                                        <input type="email" name="email"
                                            ...
                                            placeholder="example@domain.com" style="transition: all 0.15s ease 0s;"
                                    ...
                                    <div class="relative w-full mb-3">
                                        ...
                                        <input type="password"
                                            ...
                                            placeholder="Contraseña" style="transition: all 0.15s ease 0s;"
                                    ...
                                    <div>
                                        ...
                                        <span class="ml-2 text-sm font-semibold text-gray-700">Recuerdame</span></label>
                                    </div>
                                    <div class="text-center mt-6">
                                        ...
                                        @if (Route::has('password.request'))
                                            <a class="mt-4 cursor-pointer hover:text-blue-700" href="{{ route('password.request') }}">
                    ...
                    <div class="flex flex-wrap items-center md:justify-between justify-center">
                        <div class="w-full md:w-4/12 px-4">
                            <div class="text-sm text-white font-semibold py-1">
                                ...
                                <a href="https://sergiocruzes.com" class="text-white hover:text-gray-400 text-sm font-semibold py-1">Sergio G. Cruz Espinoza</a>
                            </div>
                        </div>
