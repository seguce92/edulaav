...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'gender'    =>  'Genero',
        'procedent' =>  'Procedencia',
        'father_name'   =>  'Nombre del Padre',
        'father_phone'  =>  'Telf-Cel',
        'father_email'  =>  'Correo Electronico del Padre',
        'father_occupation' =>  'Ocupación del Padre',
        'mother_name'   =>  'Nombres del Madre',
        'mother_occupation' =>  'Ocupación de la Madre',
        'mother_phone'  =>  'Telf-Cel de la Madre',
        'mother_email'  =>  'Correo electrónico de la Madre',
        'tutor_phone'   =>  'Telf-Cel del Tutor',
        'tutor_email'   =>  'Correo electrónico del Tutor'  
    ],
