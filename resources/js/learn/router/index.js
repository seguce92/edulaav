...
import RoomShowTask from '../views/rooms/partial/ShowTask'
import RoomReviewTask from '../views/rooms/partial/TasksReview'
...
const routes = [{
    ...
    children: [
...

        {
            ...
            path: '/rooms/:designation/show/task/:id',
            name: 'rooms.task.show',
            //component: () => import('../views/Index'),
            component: RoomShowTask,
            meta: { requiresVisitor: true, title: 'Tareas' }
        }, {
            path: '/rooms/:designation/show/review-task/:id',
            name: 'rooms.task.review',
            //component: () => import('../views/Index'),
            component: RoomReviewTask,
            meta: { requiresVisitor: true, title: 'Tareas' }
        },
