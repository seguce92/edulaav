    ...
    <div class="">
        <div class="w-full relative">
            <input class="appearance-none block w-full bg-gray-100 text-gray-700 border rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" readonly
                type="text" ref="filePicker" :value="value" v-on:input="$emit('input', $event.target.value)">
            <button @click="show.filemanager = true" class="flex w-12 justify-center items-center h-full bg-white rounded-r absolute right-0 top-0 hover:bg-gray-200 border">
